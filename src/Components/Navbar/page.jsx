...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-indigo-900 shadow-lg' : 'bg-transparent'}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            <Link href="/" className="flex-shrink-0">
              <span className={`font-bold text-2xl tracking-tight ${scrolled ? 'text-white' : 'text-indigo-900'}`}>AbaSatellite</span>
            </Link>
          </div>
          ...
          <div className="md:hidden">
            <button
              ...
              className={`inline-flex items-center justify-center p-2 rounded-md ${
                scrolled ? 'text-indigo-200 hover:text-white hover:bg-indigo-700' : 'text-indigo-900 hover:text-white hover:bg-indigo-100'
          ...
          <div className="relative flex-1 flex flex-col max-w-xs w-full bg-indigo-800 transform transition ease-in-out duration-300">
            ...
            <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
              <div className="flex-shrink-0 flex items-center px-4">
                <span className="font-bold text-2xl tracking-tight text-white">AbaSatellite</span>
              </div>
